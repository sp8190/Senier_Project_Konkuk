...
df = pd.read_excel('C:\Users\JJungs\Documents\GitHub\Senior_Project_Konkuk\FinalProject\distance.xlsx') #거리 데이터 정보 데이터프레임 생성
...
def opencv_img():
    prev_time = 0
    FPS = 10
    url = 'rtsp://192.168.137.84:8554/test'
